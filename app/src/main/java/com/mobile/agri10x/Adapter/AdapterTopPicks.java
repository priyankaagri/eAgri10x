...
public class AdapterTopPicks extends RecyclerView.Adapter<AdapterTopPicks.ViewHolders> {
    Context context;
    private List<GetHomeProductData> dataList;

    public AdapterTopPicks(List<GetHomeProductData> toppicksproductlist, Context context) {
