...
public class DetailofProductOrder extends RecyclerView.Adapter<DetailofProductOrder.HolderView> {
    Context context;
String valueoftotalweight;
    List<GetOrderListDatumCheckoutCartDataProduct> ProductsInOrderlistData = new ArrayList<>();


    public DetailofProductOrder(List<GetOrderListDatumCheckoutCartDataProduct> productsInOrderlistData, Context context) {
