...
public class GetBookingDeatilsDatum {
    @SerializedName("Cart_Data")
    @Expose
    private GetBookingDeatilCartData cartData;
    ...
    public GetBookingDeatilCartData getCartData() {
        return cartData;
    }

    public void setCartData(GetBookingDeatilCartData cartData) {
