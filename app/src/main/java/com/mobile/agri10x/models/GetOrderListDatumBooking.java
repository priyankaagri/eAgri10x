...
public class GetOrderListDatumBooking {
    @SerializedName("_id")
    @Expose
    private String id;
    ...
    @Expose
    private GetOrderListDatumBookingCartData cartData;
    ...
    public GetOrderListDatumBookingCartData getCartData() {
        return cartData;
    }

    public void setCartData(GetOrderListDatumBookingCartData cartData) {
